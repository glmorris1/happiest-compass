const DESTINATIONS = [
  {
    id: "happiest-compass-target",
    name: "Happiest Compass",
    lat: 33.809775,
    lon: -117.918969,
  },
];
...
function render() {
  targetName.innerHTML = `<span aria-hidden="true">&#x1F31F;</span> ${selectedTarget.name} <span aria-hidden="true">&#x1F31F;</span>`;
...
async function startCompass() {
  ...
  try {
    ...
    helperText.textContent = "Keep the phone flat and rotate your body until the needle points straight up.";
  } catch (error) {
    startButton.disabled = false;
    startButton.textContent = "Start compass";
